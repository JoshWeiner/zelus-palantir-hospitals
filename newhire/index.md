# Build with AIP - Kickstart Your Building Experience with AIP
Palantir technology powers mission-critical, real-world decisions across industries, helping operators to prevent wildfires, distribute vaccines, staff nurses, improve road safety, and more. We are so excited that you are joining us to build the future and tackle these high impact, real-world problems.

Ahead of your first day, it is encouraged to sign up for Build with AIP to get hands-on experience building directly in Palantir Foundry & AIP. 

### Setting Up Your Environment & Submissions
1. Navigate to [Build with AIP](https://build.palantir.com/) and follow the sign-up process.
